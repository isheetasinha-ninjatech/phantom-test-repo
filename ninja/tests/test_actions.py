"""Tests for ninja.actions module."""

from unittest.mock import MagicMock, call, patch

import pytest

from ninja.actions import (
    _dismiss_overlay,
...
class TestSelectorCache:
    ...
    def test_cache_records_successful_fallback(self, mock_browser):
        ...
        from ninja.actions import _selector_cache
    ...
    def test_cached_selector_tried_first(self, mock_browser):
        ...
        import ninja.actions
        from ninja.actions import _cache_url, _selector_cache

        ninja.actions._selector_cache["#btn"] = "button[name='submit']"
        ninja.actions._cache_url = "https://example.com"
    ...
    def test_cache_invalidated_on_url_change(self, mock_browser):
        ...
        ninja.actions._selector_cache["#btn"] = "fallback"
        ninja.actions._cache_url = "https://old-page.com"
